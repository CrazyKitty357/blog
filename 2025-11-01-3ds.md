...
cia - this is also an application, this can be installed to your home menu via FBI  
cxi - this is a decrypted cia, mostly used for playing games on 3ds emulators. Can be further unpacked to reveal game files.
...
lua([love2d](https://github.com/lovebrew/lovepotion)), [godot]()(early days wip), 
...
A 3DS can do everything a DS can do as well all thanks to nintendo caring about backwards compatibility when designing the 3DS. This means the 3DS is complatible with 90% of DS homebrew. The ones that aren't supported are usually full file explorers (like GM9) or require a special cartridge (this is usually PS1 emulation).  
...
There are some mods you can use to enhance playing DS games. nds bootstrap allows you to have a Rosalina menu when you play DS games. This menu can allow you to do things like see the contents of RAM (in bytes), switch CPU and VRAM clock speeds to match DSi for extra performance (only when booting games from Twilight Menu), and take screenshots. Twilight Menu++ allows you to use actionreplay cheats in games, boot games from an SD/microSD card, allow you to have multiple save files for games that don't multiple save slots (like pokemon), has support for various multimedia formats (mp3, png, ), and many more features. TWPatch allows you to mod the DS mode on your 3DS. This lets you to add 16:10 widescreen on the top screen, if you don't want to have your games be stretched be sure to apply a widescreen 16:10 actionreplay code in Twilight Menu before running the game. If you do apply widescreen via TWPatch, when booting into pixel perfect mode (holding Start and Select as you go from 3DS to DS mode) the game becomes ultrawide for some reason and runs at 10FPS; be sure to uncheck the widescreen hack checkbox if you want that back.
